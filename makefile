search.exe	: Main.o graphics.o puzzle.o algorithm.o board.o
	g++ -O2 -std=c++11 -o search.exe Main.o graphics.o puzzle.o algorithm.o board.o -l gdi32 -static-libgcc -static-libstdc++
...
board.o  : board.cpp board.h
	g++ -O2 -std=c++11 -c -Wno-write-strings board.cpp
