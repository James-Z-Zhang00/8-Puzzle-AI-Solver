...
void run_all_experiments() {
    ...
    for (int j = 0; j < num_of_init_states; j++) {
        ...
        numOfAttemptedNodeReExpansions = 0;
        actualRunningTime = 0.0;
        path = aStar_ExpandedList_Misplacedtiles(initialState, goalState, pathLength, numOfStateExpansions, maxQLength, actualRunningTime, numOfDeletionsFromMiddleOfHeap, numOfLocalLoopsAvoided, numOfAttemptedNodeReExpansions, misplacedTiles);
    ...
    for (int j = 0; j < num_of_init_states; j++) {
        ...
        numOfAttemptedNodeReExpansions = 0;
        actualRunningTime = 0.0;
        path = aStar_ExpandedList_Manhattan(initialState, goalState, pathLength, numOfStateExpansions, maxQLength, actualRunningTime, numOfDeletionsFromMiddleOfHeap, numOfLocalLoopsAvoided, numOfAttemptedNodeReExpansions, manhattanDistance);
